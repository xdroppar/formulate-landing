...
const jsonLd = {
  ...
  mainEntity: {
    ...
    description:
      "Evidence-based health platform: supplements scored out of 100 against clinical research, whole foods and meals scored on nutritional quality, and daily nutrient coverage tracked. No sponsorships.",
