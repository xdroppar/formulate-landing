...
export function BerberineVsMetformin() {
  return (
    <>
      ...
      <p>
        Both compounds can deplete <a href="/guides/vitamin-b12-guide">vitamin B12</a> with long-term use. For metformin, this is documented in large studies (de Jager et al. 2010, n=390) <EvidenceBadge level="strong" studiesId="creatine-jager-forms-2011" /> and routine B12 monitoring is now recommended by the ADA. For berberine, the B12 depletion signal comes from mechanistic plausibility and smaller datasets, not from large monitoring studies.
      </p>
      ...
      <p>The PCOS evidence for berberine is genuinely interesting — comparable hormonal and metabolic effects to metformin in short-term trials. But the population most likely to seek it out is also the population most at risk from its reproductive toxicity. If you're managing PCOS, especially with fertility goals, this decision belongs in a clinical conversation, not a supplement aisle. For the broader picture of what actually works — inositol, <a href="/guides/nac-guide">NAC</a>, <a href="/guides/best-vitamin-d-supplements">vitamin D</a>, <a href="/guides/best-magnesium-supplements">magnesium</a>, and the rest — see our <a href="/guides/best-supplements-for-pcos">best supplements for PCOS</a> guide.</p>
