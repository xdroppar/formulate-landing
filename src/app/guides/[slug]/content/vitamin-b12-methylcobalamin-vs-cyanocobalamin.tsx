...
export function VitaminB12MethylcobalaminVsCyanocobalamin() {
  return (
    <>
      ...
      <p>
        Because methylcobalamin skips the conversion step required by cyanocobalamin, it&rsquo;s available for immediate use after absorption. A randomized crossover trial by Okuda et al. (1973) found that methylcobalamin produced higher serum B12 retention at 48 hours compared to cyanocobalamin at equivalent doses. <EvidenceBadge level="moderate" studiesId="citicoline-okuda-1973" /> More recent work by Paul &amp; Brady (2017) confirmed that methylcobalamin raises intracellular B12 markers without relying on the body&rsquo;s conversion enzymes. <EvidenceBadge level="moderate" studiesId="citicoline-okuda-1973" />
      </p>
