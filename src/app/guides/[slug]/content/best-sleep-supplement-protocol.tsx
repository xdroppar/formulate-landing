  ...
  return (
    <>
      ...
      <Callout variant="info" title="Practical recommendation">
        Start at 200mg elemental magnesium glycinate. If you tolerate it well after a week and don&rsquo;t notice sufficient improvement, increase to 300–400mg. Most healthy adults will find their sweet spot in this range without GI issues. If you suspect significant deficiency, see our <a href="/guides/signs-you-are-magnesium-deficient">magnesium deficiency guide</a> — and consider asking your provider about higher repletion doses under supervision.
      </Callout>
      ...
      <p>Magnesium chelates these antibiotics the same way it chelates levothyroxine — by binding them in the GI tract. Space magnesium at least 2 hours before or 4–6 hours after your antibiotic dose. Since most people take this stack at bedtime, a morning antibiotic schedule typically solves this automatically. For more on <a href="/guides/best-magnesium-supplements">magnesium absorption and timing</a>, see our full guide.</p>
      ...
      <p>For more on how magnesium status affects sleep and mood — and signs you may be deficient — see our <a href="/guides/signs-you-are-magnesium-deficient">magnesium deficiency guide</a>. Women in perimenopause pursuing <strong>magnesium for perimenopause sleep</strong> may also benefit from the broader context in our <a href="/guides/supplement-drug-interactions">supplement drug interactions guide</a>, especially if you're managing multiple prescriptions alongside HRT.</p>
