...
export function WhatToLookForInProbiotic() {
  return (
    <>
      ...
      <p><strong>Culturelle Digestive Daily</strong> — contains <em>L. rhamnosus</em> GG at 10 billion CFU, with a CFU-through-expiration guarantee. This matches the dose and strain from the 2013 Cochrane review (Allen et al., 2010) and subsequent AAD trials. <EvidenceBadge level="strong" /> <strong>Florastor</strong> — contains <em>S. boulardii</em> CNCM I-745 at 5 billion CFU per capsule (10 billion at the two-capsule daily dose). As a yeast, it survives concurrent antibiotic use — no timing gymnastics required. Matches the strain from the 2017 Goldenberg et al. JAMA meta-analysis. <EvidenceBadge level="strong" studiesId="probiotics-cdifficile-jama-2017" /></p>

      <h3>IBS (Bloating and Abdominal Pain)</h3>
      <p><strong>Jarrow Formulas Ideal Bowel Support 299v</strong> — delivers <em>L. plantarum</em> 299v at 10 billion CFU. Multiple RCTs (Ducrotté et al., 2012; Niedzielin et al., 2001) used this strain at this dose for IBS bloating and pain. <EvidenceBadge level="moderate" studiesId="probiotics-ducrotte-lp299v-2012" /> <strong>Alflorex (Precision Biotics)</strong> — the only product using <em>B. longum</em> 35624 at the exact 1 billion CFU dose from the Whorwell et al. (2006) <em>Gastroenterology</em> trial. Single-strain, low-dose, condition-specific — the opposite of a kitchen-sink blend. <EvidenceBadge level="moderate" studiesId="probiotics-whorwell-bifido-2006" /></p>

      <h3>Infant Colic (Breastfed Infants)</h3>
      <p><strong>BioGaia Protectis Baby Drops</strong> — delivers <em>L. reuteri</em> DSM 17938 at 100 million CFU per five drops. This matches the Savino et al. (2007) and Szajewska et al. (2013) trial protocols. <EvidenceBadge level="moderate" studiesId="probiotics-lgg-pediatric-2013" /></p>
      ...
      <p>This is the most-studied probiotic strain for infant colic, and the evidence splits cleanly along feeding type. In exclusively breastfed infants, multiple RCTs — notably Savino et al. (2010) and Szajewska et al.'s 2014 meta-analysis — show <em>L. reuteri</em> DSM 17938 at 10⁸ CFU/day reduced crying time by roughly 50 minutes per day versus placebo. <EvidenceBadge level="moderate" studiesId="probiotics-lgg-pediatric-2013" /> In formula-fed infants, results are inconsistent. Sung et al. (2014) — a large, well-designed Australian trial that included both breastfed and formula-fed babies — found no significant benefit in the formula-fed subgroup. The honest summary: if you're breastfeeding, the signal is real. If you're formula-feeding, don't expect the same results.</p>
