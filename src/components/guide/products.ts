...
export const PRODUCTS: Record<string, GuideProduct> = {
  ...
  "nootropics-depot-creatine": p("nootropics-depot-creatine-monohydrate-powder", {
    ...
    brand: "Nootropics Depot",
    score: 91,
    image: "/images/products/nootropics-depot/nootropics-depot-creatine-monohydrate-powder/primary.webp",
  ...
  "nootropics-depot-taurine": p("nootropics-depot-taurine-capsules", {
    ...
    brand: "Nootropics Depot",
    score: 84,
    image: "/images/products/nootropics-depot/nootropics-depot-taurine-capsules/primary.webp",
  ...
  "nootropics-depot-magnesium-glycinate": p("nootropics-depot-magnesium-glycinate-capsules", {
    ...
    brand: "Nootropics Depot",
    score: 85,
    image: "/images/products/nootropics-depot/nootropics-depot-magnesium-glycinate-capsules/primary.webp",
  ...
  "nootropics-depot-cognizin": p("nootropics-depot-cognizin-citicoline-capsules", {
    ...
    brand: "Nootropics Depot",
    score: 87,
    image: "/images/products/nootropics-depot/nootropics-depot-cognizin-citicoline-capsules/primary.webp",
