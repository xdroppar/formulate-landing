...
**Broad:** `("ashwagandha"[MeSH Terms] OR "ashwagandha"[Title/Abstract]) AND ("thyroid medication"[MeSH Terms] OR "thyroid medication"[Title/Abstract])`
...
- https://examine.com/supplements/ashwagandha/ and /thyroid-medication/
