...
**Broad:** `("ssri"[MeSH Terms] OR "ssri"[Title/Abstract]) AND ("st johns wort"[MeSH Terms] OR "st johns wort"[Title/Abstract])`
...
- https://examine.com/supplements/ssri/ and /st-johns-wort/
