...
**Broad:** `("blood thinners"[MeSH Terms] OR "blood thinners"[Title/Abstract]) AND ("ginkgo biloba"[MeSH Terms] OR "ginkgo biloba"[Title/Abstract])`
...
- https://examine.com/supplements/blood-thinners/ and /ginkgo-biloba/
