...
**Broad:** `("vitamin k"[MeSH Terms] OR "vitamin k"[Title/Abstract]) AND ("warfarin"[MeSH Terms] OR "warfarin"[Title/Abstract])`
...
- https://examine.com/supplements/vitamin-k/ and /warfarin/
